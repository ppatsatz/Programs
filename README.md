...
> Άνοιγμα αυτής της σελίδας στο [https://ppatsatz.github.io/programs/](https://ppatsatz.github.io/programs/)
...
* αναζήτηση για **https://github.com/ppatsatz/programs** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/ppatsatz/programs/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/ppatsatz/programs** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/ppatsatz/programs/raw/master/.github/makecode/blocks.png)
